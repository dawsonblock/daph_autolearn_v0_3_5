...
def main() -> None:
    ...
    parser.add_argument("--learning-rate", type=float, default=0.05, help="Update learning rate.")
    parser.add_argument("--trust-region-radius", type=float, default=0.10, help="Trust-region radius.")
